  ...
  <table width="491" align="center" class="MYTABLE" >
    ...
    <tr class="MYTABLE">
      <td colspan="2" align="center"><h1><font color='blue'>
        <p align='center' valign='middle'>Edit your budget here</p>
      </font></h1></td>
    </tr>
    <tr class="MYTABLE">
	...
	if($result)
		...
		?>
      <td width="304"><input type="text" name="mbudget" id="mbudget" size="20" value="<?php echo $mbudget["budget"];?>" onblur="checkMB(this.value,<?php echo $mbudget["budget"]; ?>)"/>
    ...
    <tr class="MYTABLE">
      ...
      <option value="none"><font color='blue'>SELECT AGENT</font></option>
          <?php
    ...
    <tr class="MYTABLE">
      <td align="right"><font color='blue'>Budget the agent:&nbsp;&nbsp;&nbsp;</font></td>
      <td><div id="result" name="result">
        <input type="text" size="20" name="budget" id="budget"/>
      </div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
