...
$custid=$_SESSION['custid'];
 ...
 if (array_key_exists('receiver_lastname', $_SESSION))
 {
 $receiver_lastname=$_SESSION['receiver_lastname'];
 }
if($custid!=NULL)
{
	...
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		...
		{ //  alert("I am in if");
			...
			//alert ("sender2"+document.getElementById(id).value);
		         ...
		         for(i=0; i < str[i]-1; i++) {
			      document.forms[1].getElementById[i]+15.value=str[i];
				 }
				 
		   //document.getElementById('userid;
//	   	  document.getElementById('receiver_firstname').value=str[i];
//		   document.getElementById('$receiver_middlename=$row2[5];
//		   
//		   document.getElementById('$receiver_lastname = $row2[6];
//		   
//		   document.getElementById('$receiver_gender   = $row2[7];
//		   
//		   document.getElementById('$receiver_address1= $row2[8];
//		   
//		   document.getElementById('$receiver_address2= $row2[9];
//		   
//		   document.getElementById('$receiver_city= $row2[10];
//		   
//		   document.getElementById('receiver_province= $row2[11];
//		   
//		   document.getElementById('receiver_country= $row2[12];
//		   
//		   document.getElementById('receiver_postalcode= $row2[13];
//		   
//		   document.getElementById('receiver_phone1= $row2[14];
//		   
//		   document.getElementById('receiver_phone2= $row2[15]; 
//		   
//		   document.getElementById('receiver_email= $row2[16];
//		   
//		   document.getElementById('receiver_pid= $row2[17];
//		   
//		   document.getElementById('receiver_photoid= $row2[18];
...
<SELECT NAME ="receiver" id="receiver" STYLE = "width: 100" onchange=\"reload(this.form)\">  
	  ...
	  if($numrows1!=0)
	  {
		...
		{   
		  $Sreceiver_firstname= $row1[0];
		  $Stransactionid=$row1[1];
		//  echo"<option value= '$Sreceiver_firstname'> $Sreceiver_firstname</option>";
		  echo"<option value= $row1[1]> $Sreceiver_firstname</option>";
