...
<table width="1221" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr></tr>
  <tr>
    <td colspan="24" align="center">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="24" align="center"><h2><b><font style='color:#920'> Agent Info</font></b></h2></td>
  </tr>
  <tr>
	...
	if($result)
	{
		...
		if($num_rows >0)
		{
			...
			while($rows = mysql_fetch_array($result))
			{
				 ...
				 echo " <td><div id='del".$rows[0]."' class='tt' ><a href='deleteAgent.php?id=".$rows[0]."'onclick=\'confirmit(this.id);\'>delete?</a></div></td>";
				 echo "<td><div id='upd".$rows[0]."' class='tt' ><a href='updateAgent.php?id=".$rows[0]."'>update?</a></div></td>";
				 echo "  </tr>";
				 $count++;
			}
		}
