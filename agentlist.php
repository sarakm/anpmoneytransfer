...
<tr height="70px"><td colspan="4"><div align="center"><a href="/ANP/registerStaff.php" align="left"><img src="/ANP/img/register_agent.jpg"/> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/ANP/modify_agent.php" align="center"><img src="/ANP/img/modify_agent.jpg"/> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/ANP/del_agents.php" align="right"><img src="/ANP/img/delete_agent.jpg"</a></div></td></tr>

<tr><td>

<form name="FORM">
<input type="hidden" name="rank" id="rank" value="<?php echo $_SESSION['rank'] ?>"/>
<table width="458" height="117" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr></tr>
  <tr>
    <td colspan="24" align="center">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="24" align="center"><div class="caption"> Agent Info</div></td>
  </tr>
  <tr>
    <td colspan="24" align="center"><font style='color:#900'><div id="message" name="message">
      <?php
  ...
  <tr>
    <td colspan="24"><table width="300" border="0" cellspacing="0" cellpadding="0">
