...
<body>
    ...
    $prg->surrounded = '1';
	$prg->heading=" Yearly Transactions Report";
	...
	$sql = "select * from transactions where year(date_submitted)='".$year."' order by transactionid";
	else if($_SESSION['rank']=='BRANCH MANAGER')
	$sql = "select * from transactions where year(date_submitted)='".$year."' and trans_booker=$ag order by transactionid";
