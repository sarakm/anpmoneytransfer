...
function searchAgent() {
	if (searchReq.readyState == 4 || searchReq.readyState == 0) {
		...
		var area= escape(document.getElementById('receiver_province').value);
		var coutry= escape(document.getElementById('receiver_country').value);
		searchReq.open("GET", 'searchAgent.php?province='+ area +'country='+ country + 'search=' + str, true);
