...
if(!isset($firstname) || !isset($lastname) || !isset($gender)||!isset($address1)|| !isset($city) || !isset($country) ||!isset($phone1) )
...
if (email.length>=1 && (!echeck(email)))
 ...
 if (pid.length == 0 || pid.length < 9)
	{
		alert("Proper SSN or DRIVERS LICENCE number required! ");
		return false;
	}
...
<body>
<center><font color="#900" size="8" ><?php if($_REQUEST['msg']!="") {echo $_REQUEST['msg'];}?></font></center>
<FORM  ACTION="register.php" METHOD="POST">
  <table width="656" class="MYTABLE" ALIGN="CENTER">
    ...
    <tr class="MYTABLE">
      <td width="11" class="MYTABLE"></td>
      <td width="88" align="right"  class="MYTABLE"><label class="MYTABLE">CustId</label></td>
      <td width="11"></td>
      <td width="220"><input type="text" name="custId" id="custId" value=""  onFocus="this.disabled=true" AUTOCOMPLETE="off" title="Please do not enter any value"/></td>
    </tr>
      <tr class="MYTABLE">
