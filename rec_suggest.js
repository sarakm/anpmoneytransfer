...
function receiverSuggest(id) {
	...
	if (cityReq.readyState == 4 || cityReq.readyState == 0) {
		...
		if (str.length > 2)
		{
			cityReq.open("GET", 'receiverSuggest.php?search=' + str, true);
			cityReq.onreadystatechange = handleReceiverSuggest;
			cityReq.send(null);
		}
	}
}
function handleReceiverSuggest() {
