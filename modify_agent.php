...
<table width="997" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr></tr>
  <tr>
  ...
  <tr>
    <td colspan="24" align="center"><font style='color:#666666'>
      <div id="message" name="message" >
        <?php
			...
			//	echo $_SESSION["del_Agent_Message"];
		     ...
		     if(isset($_SESSION['update_Agent_Message']))
			{
				echo "<h2><strong>".$_SESSION['update_Agent_Message']."</strong></h2>";
		...
		if($num_rows >0)
		{
			...
			while($rows = mysql_fetch_array($result))
			{
			  ...
			  // echo "<td>".$rows['address2']."</td>";
				...
				// echo "<td>".$rows['postalcode']."</td>";
			  
				 echo "<td>".$rows['phone1']."</td>";
			   //  echo "<td>".$rows['phone2']."</td>";
				// echo "<td>".$rows['email']."</td>"; 
				 echo "<td>".$rows['fax']."</td>"; 
			  /* echo "<td>".$rows['PID_DLN']."</td>"; 
				 echo "<td>".$rows[16]. "</td>";
				 echo "<td>".$rows[17]."</td>";
				 echo "<td>".$rows[18]."</td>";
				 echo "<td>".$rows[19]."</td>";
				 ...
				 echo "<td>".$rows['budget']."<input type='hidden' name='fname' id='fname' value='".$rows[1]."'/></td>";
